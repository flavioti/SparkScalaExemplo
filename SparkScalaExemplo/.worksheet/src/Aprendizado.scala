object Aprendizado {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(124); 
...
// VALUES are immutable constants. You can't change them once defined.
  ...
  val isBest: Boolean = picard == bestCaptain;System.out.println("""isBest  : Boolean = """ + $show(isBest ));$skip(326); 
  ...
  println(vogais._3);$skip(25); 
  
  
  println("TUPLA");$skip(35); 
	val tuplaNomeIdade = "Flavio"->34;System.out.println("""tuplaNomeIdade  : (String, Int) = """ + $show(tuplaNomeIdade ));$skip(22); 
	
	
	println("ARRAY");$skip(39); 
	val arrayVogais=("A","E","I","O","U");System.out.println("""arrayVogais  : (String, String, String, String, String) = """ + $show(arrayVogais ));$skip(20); 
  ...
  println("FILTER");$skip(53); 
	...
	val semDoisTambem = listaNumero.filter( _ != 2 );System.out.println("""semDoisTambem  : List[Int] = """ + $show(semDoisTambem ));$skip(29); 
  ...
  val distinto = listaNumeroDesordenada.distinct.sorted;System.out.println("""distinto  : List[Int] = """ + $show(distinto ));$skip(45); 
  
  var maximo = listaNumeroDesordenada.max;System.out.println("""maximo  : Int = """ + $show(maximo ));$skip(42); 
  var minimo = listaNumeroDesordenada.min;System.out.println("""minimo  : Int = """ + $show(minimo ));$skip(54); 
  
  var contem3 = listaNumeroDesordenada.contains(3);System.out.println("""contem3  : Boolean = """ + $show(contem3 ));$skip(48); 
  
  var somaItens = listaNumeroDesordenada.sum;System.out.println("""somaItens  : Int = """ + $show(somaItens ));$skip(61); 
